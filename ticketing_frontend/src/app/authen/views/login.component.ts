        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
          <div class="width-540px mx-auto py-5">
            <div class="w-100 bg-color-brand text-color-white rounded-top">
              <h4 class="text-center poppins fontsize-30 m-0 py-2 px-0 weight-400">{{appname || 'Ticket Management System'}}</h4>
            </div>
            <div class="w-100 bg-gray height-470px text-center">
                <div class="logo">
                  <div class="py-5">
                    <img src="./../../../assets/images/neco_logo.png" class="mt-3">
                  </div>
                </div>
                  ...
                  <label
                    ...
                    <label
                      *ngIf="submitted && f['email'].errors?.['email']"
                      >{{ getErrorMessage('email', 'invalid') }}</label
                    >
                  </div>
                    <div class="d-flex justify-content-start mt-4">
                      ...
                      <div class="w-100">
                        ...
                        <i class="fa-solid " [ngClass]=" hide ? 'fa-eye-slash' : 'fa-eye'" (click)="eyehide()"></i>
                        </div>                  
                      </div>   

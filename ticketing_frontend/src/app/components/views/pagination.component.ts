...
import { paginationModel } from '../models/paginationModel.model';
...
export class PaginationComponent implements OnInit{
  @Input() paginationDetails: paginationModel;
  @Output() paginationNumber: EventEmitter<any> = new EventEmitter<any>();
  constructor() {}
  ngOnInit(): void {
    console.log('my pagination details>>>', this.paginationDetails);
  }
